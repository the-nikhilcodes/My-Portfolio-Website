...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (newsletterForm && newsletterEmail) {
        newsletterForm.addEventListener("submit", function (e) {
            ...
            setTimeout(() => {
                showNotification(`🎉 Thanks for subscribing! Welcome to our newsletter, ${email}!`, "success");
    ...
    if (loadMoreBtn) {
        loadMoreBtn.addEventListener("click", function () {
            ...
            setTimeout(() => {
                showNotification("No more articles available at the moment. Check back soon! 📰", "info");
    ...
    tagElements.forEach(tag => {
        tag.addEventListener("click", function () {
            ...
            showNotification(`Searching for articles tagged with "${tagText}"...`, "info");
